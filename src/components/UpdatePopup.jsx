...
const UpdatePopup = ({ onSave, onClose, defaultValues }) => {
  const [rank, setRank] = useState(defaultValues.rank);
  const [percentile, setPercentile] = useState(defaultValues.percentile);
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-[450px]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
          <div className="flex items-center">
            ...
            <label className="text-sm font-medium text-gray-700">
              Update your <strong className="text-black">Current Score (Out of 15)</strong>
            </label>
          </div>
          <input
            type="number"
