...
const DynamicComparisonGraph = ({ percentile }) => {
  ...
  return (
    <div>
      <p className="text-gray-700 mb-4">
        <strong>You scored {percentile}% percentile</strong> which is lower than<br /> the average percentile <strong>72%</strong> of all the engineers who took this assessment.
      </p>
